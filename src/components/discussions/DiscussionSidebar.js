...
// Define static group data outside component to avoid hydration mismatch
const STATIC_GROUP_INFO = {
...
const STATIC_RECENT_DISCUSSIONS = [
  {
    id: 'assignment-help',
...
export default function DiscussionsPage() {
  const [groupInfo] = useState(STATIC_GROUP_INFO); // Use static data directly
  ...
  // Fix hydration by only running effects on client
  useEffect(() => {
    setIsClient(true);
  }, []);
  ...
  const filteredDiscussions = STATIC_RECENT_DISCUSSIONS.filter(discussion =>
